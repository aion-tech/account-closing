...
def migrate(cr, version):
    ...
    account_templates = {account_code: env.ref(f'l10n_it_marco.{account_code}') for account_code in ['2607', '2608']}
    companies = env['res.company'].search([('chart_template_id', '=', env.ref('l10n_it_marco.l10n_it_chart_template_marco').id)])
